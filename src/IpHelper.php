...
class IpHelper
{
    ...
    /**
     * IPv4 address regexp. This pattern is PHP and JavaScript compatible.
    ...
    /**
     * IPv6 address regexp-pattern. This regexp is PHP and Javascript compatible.
     */
    public const IPV4_REGEXP = '/^' . self::IPV4_PATTERN . '$/';
    /**
     * IPv6 address regexp-pattern. This pattern is PHP and Javascript compatible.
